...
inline agiros_msgs::Command toRosCommand(const agi::Command& command) {
  agiros_msgs::Command ros_command;
...
inline agiros_msgs::QuadState toRosQuadState(const agi::QuadState& state) {
