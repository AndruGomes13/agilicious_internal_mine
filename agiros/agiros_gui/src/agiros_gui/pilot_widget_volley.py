...
class PilotWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        ui_file = os.path.join(
            ...
            '../../resource/pilot_widget_volley.ui')
        loadUi(ui_file, self)
    ...
    def connect(self, quad_namespace):
        ...
        self.button_start_policy.setEnabled(True)
        self.button_stop_policy.setEnabled(True)
    ...
    def on_policy_status_cb(self, msg):
        w = self.status_policy_running   
        ...
        if update_needed:
            ...
            elif self._policy_status is True:
                w.setText("RUNNING")
                w.setStyleSheet(
                    "background: green; color: white; "
                    "border: 1px solid black; border-radius: 4px;")
                
            elif self._policy_status is False:
                w.setText("STOPPED")
                w.setStyleSheet(
